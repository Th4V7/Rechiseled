...
public class RechiseledBlocks {
    ...
    // Copper block
    public static final RechiseledBlockType COPPER_BLOCK_BARS = create("copper_block_bars", "Copper Bars Block", () -> Blocks.COPPER).recipe(BaseChiselingRecipes.COPPER_BLOCK).build();
